  ...
  return (
    <>
      ...
      <button
        ...
        className="lg:hidden fixed top-4 left-4 z-50 w-10 h-10 rounded-lg bg-sidebar border border-sidebar-border flex items-center justify-center text-sidebar-foreground"
      >
